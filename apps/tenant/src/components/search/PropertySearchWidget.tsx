  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? "text-ocean-blue font-semibold bg-ocean-blue/5"
          : "text-gray-700",
      )}
    >
      {children}
...
export function PropertySearchWidget({
  ...
  const [openDropdown, setOpenDropdown] = useState<
    "type" | "minPrice" | "maxPrice" | "beds" | null
  >(null);
    ...
    <div className={cn("w-full", className)}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 4px 32px rgba(37,99,235,0.13), 0 1px 0 rgba(255,255,255,0.9) inset",
        ...
        <div ref={locationRef} className="relative w-full">
          <label className="flex items-center gap-4 px-8 pt-5 pb-5 cursor-text hover:bg-ocean-blue/3 rounded-t-2xl transition-colors">
            ...
            <div className="flex flex-col min-w-0 flex-1">
              <span className="text-[10px] font-bold uppercase tracking-widest text-ocean-blue/70 mb-0.5">
                Location
              </span>
              <input
                type="text"
        ...
        <div className="flex items-stretch">
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                ...
                openDropdown === "type"
                  ? "bg-ocean-blue/5"
                  : "hover:bg-ocean-blue/3",
              )}
            >
              <Home className="w-4 h-4 text-ocean-blue shrink-0" />
              <div className="flex flex-col items-start text-left flex-1">
                <span className="text-[10px] font-bold uppercase tracking-widest text-ocean-blue/70">
                  Property Type
                </span>
              ...
              {TYPE_OPTIONS.map((opt) => (
                <DropdownItem
                  ...
                  active={
                    ...
                    (!filters.propertyType && opt === "Any")
                  }
                  onClick={() => {
                    onFiltersChange({ propertyType: opt });
                    close();
                  }}
                >
          ...
          <div className="flex items-center gap-2 px-4 py-4 shrink-0">
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, hsl(214 100% 55%) 0%, hsl(214 100% 42%) 100%)",
        ...
        >
          <div className="flex items-center gap-3 px-5 py-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-widest text-ocean-blue/70 mb-0.5">
                Location
              </p>
              <input
                type="text"

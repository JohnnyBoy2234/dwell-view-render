...
const featuresContent: Record<Mode, {
  ...
  rent: [
    ...
    },
    {
      ...
      description: "Publish your property, screen tenants, and sign in minutes. No middlemen.",
      accent: "hsl(25 95% 53%)",
    },
    {
...
const ctaContent: Record<Mode, {
  ...
  rent: {
    ...
    primaryLabel: 'Add Your Property',
    primaryHref: '/listing-type',
  ...
  buy: {
    line1: 'Sell smarter.',
    line2: 'Keep more.',
    subtext: "List your property on South Africa's most trusted commission-free platform.",
            ...
            >
              <div className="text-center mb-14">
                ...
                <h2 className="mt-3 text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">
                  {mode === 'rent' ? 'Built for modern landlords' : 'Built for modern property sales'}
                </h2>

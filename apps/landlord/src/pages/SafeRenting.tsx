        ...
        <section className="bg-ocean-blue text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              Your safety is our top priority. Learn about the comprehensive security measures that protect every rental transaction on MzanziHomes.
            </p>
            <Button 
              asChild
              size="lg" 
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-muted-foreground">
                      ...
                      <p>
                        • Always use MzanziHomes's secure messaging system
                      </p>
                      <p>

-- Fix KYC approval notification copy and function args
-- Updates notify_on_kyc_status_change to use a single message field and correct create_notification signature

  ...
  public: {
    Tables: {
      ...
      application_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "application_requests_landlord_id_fkey"
            columns: ["landlord_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "application_requests_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "application_requests_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      promote_to_landlord: { Args: never; Returns: undefined }
      update_lease_status: {

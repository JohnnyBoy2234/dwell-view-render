...
export default function Messages() {
  ...
  // Use EnhancedDashboardLayout for both landlords and tenants
  return (
                ...
                <div className="p-4 border-t">
                  <form onSubmit={handleSendMessage} className="flex gap-2">
                    <Input
                      ...
                      className="flex-1"
                    />
                    <Button type="submit" disabled={!newMessage.trim()} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                      <Send className="h-4 w-4" />
                    </Button>
                  </form>
                </div>

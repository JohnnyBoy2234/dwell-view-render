...
import { LandlordDashboardHeader } from '@/components/dashboard/landlord/LandlordDashboardHeader';
import { MetricsGrid } from '@/components/dashboard/landlord/MetricsGrid';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Home, Eye, Plus, Users, MessageSquare, FileText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-earth-light/30">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Properties Section */}
        <Card className="shadow-medium border-ocean-blue/20 bg-gradient-to-br from-white to-earth-light/20 mb-8">
          <CardHeader>
                        ...
                        <div className="flex items-center justify-between pt-2">
                          ...
                          <div className="flex gap-1">
                            <Button size="sm" variant="ghost" onClick={(e) => {
                              e.stopPropagation();
                              navigate(`/dashboard/applications/${property.id}`);
                            }}>
                ...
                {tenants.map((tenant) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        <Button size="sm" variant="ghost" onClick={() => navigate(`/messages?tenant=${tenant.id}`)}>
                          <MessageSquare className="h-3 w-3" />
                        </Button>

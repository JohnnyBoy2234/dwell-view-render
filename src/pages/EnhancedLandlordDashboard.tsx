...
export default function EnhancedLandlordDashboard() {
  ...
  const renderPaymentsTab = () => (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        <RandMoneyBagIcon className="h-6 w-6 text-ocean-blue" />
      ...
      {tenants.length === 0 ? (
        <Card>
          <CardContent className="p-8 text-center">
            <RandMoneyBagIcon className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              ...
              >
                <div className="w-10 h-10 bg-gradient-to-br from-ios-teal to-ios-green rounded-ios mx-auto mb-2 flex items-center justify-center">
                  <RandMoneyBagIcon className="w-5 h-5 text-white" />
                </div>

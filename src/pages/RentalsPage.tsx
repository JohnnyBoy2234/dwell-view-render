    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-earth-light/30 to-ocean-blue/5">
      <div className="container mx-auto p-6">
        ...
        <div className="mb-8 p-6 rounded-2xl bg-ocean-blue/10 border border-ocean-blue/20 shadow-soft">
          <h1 className="text-4xl font-bold text-ocean-blue mb-2">Properties for Rent</h1>
          <p className="text-lg text-muted-foreground">
            {searchTerm ? `Searching for rentals in ${searchTerm}` : `Discover ${properties.length} rental properties across South Africa`}
          </p>
        </div>
        ...
        <ResponsivePropertyGrid 
          ...
          onShowAllProperties={() => navigate('/rentals')}
        />

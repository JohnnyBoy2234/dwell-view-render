...
export default function SalesPage() {
  ...
  const filteredProperties = properties.filter(property => {
    ...
    // Price range filter (use sale_price for sales)
    const propertyPrice = property.sale_price || property.price;
    if (minPrice && propertyPrice < parseInt(minPrice)) {
      return false;
    }
    if (maxPrice && propertyPrice > parseInt(maxPrice)) {
      return false;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-earth-light/30 to-ocean-blue/5">
      <div className="container mx-auto p-6">
        ...
        <div className="mb-8 p-6 rounded-2xl bg-ocean-blue/10 border border-ocean-blue/20 shadow-soft">
          <h1 className="text-4xl font-bold text-ocean-blue mb-2">Properties for Sale</h1>
        ...
        <ResponsivePropertyGrid 
          ...
          onShowAllProperties={() => navigate('/sales')}
        />
